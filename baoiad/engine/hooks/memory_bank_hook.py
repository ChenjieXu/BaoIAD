...
class MemoryBankHook(Hook):
    ...
    For methods like PatchCore, PaDiM, memory-bank baseline that collect features
    ...
    def after_train(self, runner) -> None:
        ...
        memory-bank methods such as PatchCore/PaDiM/memory-bank baseline, re-fitting here would
