...
"""Official RD++ simplex noise helper.

Vendored from the RD++/ADer reference implementation with a soft fallback for
environments where ``numba`` is unavailable or incompatible with the local
NumPy build.
"""
...
except Exception:  # pragma: no cover - exercised only in incompatible envs
