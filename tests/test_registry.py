...
from baoiad.registry import DATASETS, HOOKS, LOOPS, METRICS, MODELS, TRANSFORMS, VISUALIZERS
...
class TestRegistries:
    ...
    def test_transform_registration(self):
        for name in ['LoadImage', 'LoadMask', 'ResizeAD', 'NormalizeAD', 'PackADInputs']:
