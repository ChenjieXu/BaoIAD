...
from baoiad.models.detectors.uflow import resolve_cait_pretrained_overlays
...
class TestUFlowDetector(TestCase):
    def setUp(self):
        self.cfg = dict(type='UFlowDetector', input_size=(64, 64), flow_steps=2, backbone='resnet18')
