...
def _load_module():
    path = ROOT / 'tools' / 'cutpaste_ablation.py'
    spec = importlib.util.spec_from_file_location('baoiad_cutpaste_ablation', path)
...
def test_build_cutpaste_localpth_overrides():
    ...
    assert overrides['model.backbone.checkpoint_path'] == '/tmp/tf_efficientnet_b4_aa-818f208c.pth'
