...
from baoiad.datasets.glass_dataset import GLASSDataset
from baoiad.datasets.transforms import PackADInputs, PackGLASSInputs
...
def test_glass_dataset_train_uses_distribution_foreground_fallback(tmp_path, monkeypatch):
    data_root = tmp_path / 'mvtec'
