...
# Stage 2 must consume the Stage 1 text adapter from the same strict-alignment
# reproduction track. Override via --cfg-options when using a different stage1
# work dir.
stage1_text_adapter_ckpt = 'runs/alignment/aaclip_strict_align/stage1/epoch_5.pth'
