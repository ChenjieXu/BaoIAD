...
Usage:
    python tools/benchmark_speed.py --methods patchcore,padim,stfpm --gpu 0 --output results/speed_patchcore.json
...
def _setup_dummy_banks(model, device):
    ...
    if head is not None:
        ...
        # SPADE head — set per-layer feature stats
    ...
    # GraphCore — set memory bank tensor directly
